...
public class Client {
    ...
    public static void printEmployees(){
        ...
        ArrayList<Employee> employees = EmployeeJDBC.getEmployees();
    ...
    public static void printEmployeeById(int id){
        ...
        Employee emp = EmployeeJDBC.getEmployeeById(id);
        if(emp == null)
    ...
    public static void addNewEmployee(Employee e){
        ...
        Employee emp3 = EmployeeJDBC.addEmployee(e);
    ...
    public static void updateEmployee(int id, Employee e){
        Employee emp = EmployeeJDBC.updateEmployeeById(2, e);
        if(emp != null) {
            System.out.println("Succesfully Updated Employee with ID " + id + ": " + emp);
        }
    }

    public static void deleteEmployee(int id){
        if(EmployeeJDBC.deleteEmployeeById(id)) {
...
//        System.out.println("*************************************************\n");
//
//        System.out.println("Update Employee with ID 2 with Employee ID 3: ");
